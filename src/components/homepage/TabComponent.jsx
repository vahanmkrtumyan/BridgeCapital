                        ...
                        render={({
                          ...
                          <Fade delay={150}>
                            <div className="my-collapsible text-inside">
                              ...
                              <p>
                                Ընկերությունը մատուցում է բրոքերային
                                ծառայություններ տեղական և արտասահմանյան
                                կարգավորվող և չկարգավորվող հարթակներում
                                շրջանառվող արժեթղթերի գծով և իր հաճախորդներին
                                տալիս է համաշխարհային մեծագույն բորսաներում
                                ցուցակված արժեթղթերում ներդրումներ կատարելու
                                հնարավորություն:
                              </p>
                              <p>
                                Բրոքերային սպասարկման շրջանակներում
                              ...
                              >
                                <div className="my-collapsible__content-inner">
                                  <ul className="ul">
                                    ...
                                    <li>
                                      կապի այն միջոցները, որոնցով հաճախորդը
                                      կարող է կատարել արժեթղթերով գործարքներ։
                                    </li>
                                  </ul>
                                  <p>
                                  ...
                                  <p>
                                    Բրոքերային ծառայություններին առավել
                        ...
                        <SlideToggle
                          ...
                          render={({ onToggle, setCollapsibleElement }) => (
                            <Fade delay={150}>
                              <div className="my-collapsible text-inside">
                                <strong>
                                  Բրիդջ Կապիտալ ՓԲԸ-ն առաջարկում է արժեթղթերի
                                  շուկայում ներդրումների հետ կապված
                                  մասնագիտացված խորհրդատվական ծառայություններ,
                                  մասնավորապես՝
                                </strong>
                                <ul className="ul">
                                  <li>
                            ...
                            <Fade delay={150}>
                              <div className="my-collapsible text-inside">
                                <strong>
                                  ...
                                  հաճախորդի կողմից տվյալ փոխարկման պահանջը բխում
                                  է արժեթղթերում ներդրումներ կատարելու
                                  հանգամանքից:
                                </strong>
                                <p>
                                  Ընկերությունն այդ նպատակով մշտապես ապահովում է
                                  երկկողմանի գնանշումներ ՀՀ դրամ, ԱՄՆ դոլար,
