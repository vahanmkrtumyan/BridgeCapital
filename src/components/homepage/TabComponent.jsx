                          ...
                          <Fade delay={150}>
                            <div className="my-collapsible text-inside">
                              ...
                              <p>
                                ...
                                ընդունում է յուրաքանչյուր աշխատանքային օր ժամը
                                9:30-ից մինչև 16:00:
                              </p>
                            ...
                            <Fade delay={150}>
                              <div className="my-collapsible text-inside">
                                <strong>
                                  ...
                                  խորհրդատվական ծառայություններ անհատներին,
                                  արտասահմանյան և տեղական ընկերություններին:
                                </strong>
                                <p>
                          ...
                          render={({ onToggle, setCollapsibleElement }) => (
                            <Fade delay={150}>
                              <div className="my-collapsible text-inside">
                                ...
                                <p>
                                  Բրիդջ Կապիտալ ՓԲԸ-ն իր հաճախորդներին
                                  առաջարկում է պայմանագրային հիմունքներով սվոպ
                                  գործարքների կնքում ներքին և միջազգային
                                  շուկաներում:
                                </p>

                                <p>
                                  Ընկերությունը հաճախորդներին առաջարկում է իր
                                  կողմից գնանշվող արժույթներով ֆորվարդային
                                  գործարքներ, որոնց իրականացման
                                  ժամկետայնությունը պայմանավորված է գործարքի
                                  արժույթով: Արտարժույթ-արտարժույթ գործարքների
                                  դեպքում ժամկետը կարող է սահմանվել մինչև մեկ
                                  տարի: Արտարժույթ-ՀՀ դրամ գործարքների դեպքում
                                  ժամկետը սահմանվում է` ելնելով շուկայի
