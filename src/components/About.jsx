            ...
            <div className="about-modal-info text-inside">
              ...
              <div className="pb-10">
                <p>
                  ...
                  <br />
                  2016թ հունիս ամսից §Արմհոլդինգ¦ ՓԲԸ-ում զբաղեցնում է
                  ...
                  մատուցող ֆիզիկական անձի՝ բրոքերի¦ հավաստագիր:
                </p>
              </div>
            </div>
          </div>
        ...
        <Modal open={this.state.Anna} onClose={this.onCloseModal} center>
          <div className="about-modal">
            ...
            <div className="about-modal-info text-inside">
              ...
              <div className="pb-10">
                <p>
                  Ծնվել է 04.05.1990թ-ին Հայաստանի Հանրապետության Գեղարքունիքի
                  մարզի Սարուխան գյուղում: 2007-2013թթ-ին սովորել է Հայաստանի
                  Պետական Տնտեսագիտական Համալսարանի Ֆինանսական ֆակուլտետի
                  §Արժեթղթերի վերլուծություն և կառավարում¦ բաժնում:
                  <br />
                  01/06/2013-16/06/2017 աշխատել է §ՌԵՍՈ¦ Ապահովագրական ՓԲԸ-ում
                  որպես հաշվապահ:
                  <br />
