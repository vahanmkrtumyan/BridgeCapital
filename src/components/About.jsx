            ...
            <div className="cols-sm-2 cols-mb justify-between ">
              ...
              <section className="col-md-7 col-sm-8 text-inside">
                ...
                >
                  ...
                  <ul className="ul">
                    <li>
                      ...
                      Ընկերության հաճախորդներին:
                    </li>
                    <li>
                      ապահովել հասանելիություն միջազգայնորեն ճանաչված
                      ներդրումային հարթակներին:
                    </li>
                    <li>
                ...
                >
                  ...
                  <p>
                    Նշանակալից մասնակից – Նարգիզյան Նարեկ Վարդանի
                    <br />
            ...
            <div className="about-modal-info text-inside">
              ...
              <div className="pb-10">
                <p>
                  ...
                  <br />
                  2007-2011թթ.-ին սովորել է Հայաստանի պետական տնտեսագիտական
                  համալսարանի Ինֆորմատիկայի և վիճակագրության ֆակուլտետի
                  §Մաթեմատիկական մոդելավորում և գործառնությունների
                  հետազոտություն տնտեսագիտության մեջ¦ բաժնում։
                  <br />
                  2013թ.-ի նոյեմբերից-2018թ.-ի փետրվարը աշխատել է §Կոմֆորտ Ռ և
                  Վ¦ ՍՊԸ-ում տարբեր պաշտոններում (շուկայի զարգացման մենեջեր,
                  վերլուծաբան, գլխավոր հաշվապահի ժ/պ)։
                  <br />
                  2018թ.-ի հունիսից §Գլավսնաբ¦ ՓԲԸ-ում զբաղեցնում է գլխավոր
                  հաշվապահի պաշտոնը։
                  <br />
                  2018թ.-ի մարտից §Վոլիոս¦ ՓԲԸ-ում զբաղեցնում է գլխավոր
                  հաշվապահի պաշտոնը։
                  <br />
                  2019թ.-ի հունվարից §Բրիդջ Կապիտալ¦ ՓԲԸ-ում զբաղեցնում է
                  բրոքերի պաշտոնը։
                  <br />
                  2018թ.-ի դեկտեմբերին Հայաստանի բանկերի միության կողմից ստացել
            ...
            <div className="about-modal-info text-inside">
              ...
              <div className="pb-10">
                <p>
                  ...
                  <br />
                  2018 թ-ի դեկտեմբերի 24-ից մինչ օրս աշխատում է §Բրիդջ Կապիտալ¦
                  ՓԲԸ-ում որպես ներքին աուդիտի ղեկավար:
                  <br />
            ...
            <div className="about-modal-info text-inside">
              ...
              <div className="pb-10">
                <p>
                  ...
                  <br />
                  2016 թ.–ի հունիս ամսից §Արմհոլդինգ¦ ՓԲԸ-ում զբաղեցնում է
                  հաշվապահի, այնուհետև գլխավոր հաշվապահի պաշտոնը:
                  <br />
